...
public class WalletViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(Wallet wallet : walletList){
            ...
            tr.addView(getTextView(wallet.getId() + walletList.size(), Integer.toString(wallet.getAmount()), Color.WHITE, Typeface.NORMAL, ContextCompat.getColor(this, R.color.colorAccent)));
